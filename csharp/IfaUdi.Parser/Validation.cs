...
internal static class Validation
{
    ...
    public static readonly Regex ForbiddenLotSnChars = new(@"[\x00-\x1F\x7F-\xFF#$@\[\\\]\^`{|}~]", RegexOptions.Compiled);

    public static readonly Regex ItemReferenceCharset = new(@"^[0-9A-Z.\-]+$", RegexOptions.Compiled);

    public static readonly Regex AlphanumericUpperCharset = new(@"^[0-9A-Z]+$", RegexOptions.Compiled);
}
